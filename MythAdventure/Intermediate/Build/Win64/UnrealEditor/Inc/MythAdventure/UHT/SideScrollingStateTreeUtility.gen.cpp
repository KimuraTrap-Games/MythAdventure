...
#include "MythAdventure/Variant_SideScrolling/AI/SideScrollingStateTreeUtility.h"
...
MYTHADVENTURE_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
MYTHADVENTURE_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_MythAdventure(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
struct Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TargetPlayer_MetaData[] = {
		{ "Category", "StateTreeGetPlayerInstanceData" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Holds the found player pawn */" },
#endif
		{ "ModuleRelativePath", "Variant_SideScrolling/AI/SideScrollingStateTreeUtility.h" },
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_MythAdventure(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_scott_Desktop_MythAdventure_MythAdventure_Source_MythAdventure_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_MythAdventure_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 2678738359U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 3963259211U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_scott_Desktop_MythAdventure_MythAdventure_Source_MythAdventure_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_MythAdventure_611074678(TEXT("/Script/MythAdventure"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_scott_Desktop_MythAdventure_MythAdventure_Source_MythAdventure_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_MythAdventure_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_scott_Desktop_MythAdventure_MythAdventure_Source_MythAdventure_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_MythAdventure_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
