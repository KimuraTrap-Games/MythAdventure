...
#include "MythAdventure/Variant_Combat/CombatDamageableBox.h"
...
MYTHADVENTURE_API UClass* Z_Construct_UClass_ACombatDamageableBox();
MYTHADVENTURE_API UClass* Z_Construct_UClass_ACombatDamageableBox_NoRegister();
...
#endif
		{ "ModuleRelativePath", "Variant_Combat/CombatDamageableBox.h" },
#if !UE_BUILD_SHIPPING
...
struct Z_Construct_UClass_ACombatDamageableBox_Statics
{
...
#endif
		{ "IncludePath", "Variant_Combat/CombatDamageableBox.h" },
		{ "ModuleRelativePath", "Variant_Combat/CombatDamageableBox.h" },
#if !UE_BUILD_SHIPPING
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ACombatDamageableBox_OnBoxDamaged, "OnBoxDamaged" }, // 2042316669
		{ &Z_Construct_UFunction_ACombatDamageableBox_OnBoxDestroyed, "OnBoxDestroyed" }, // 4084215099
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACombatDamageableBox_Statics::NewProp_CurrentHP = { "CurrentHP", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACombatDamageableBox, CurrentHP), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurrentHP_MetaData), NewProp_CurrentHP_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACombatDamageableBox_Statics::NewProp_DeathDelayTime = { "DeathDelayTime", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACombatDamageableBox, DeathDelayTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DeathDelayTime_MetaData), NewProp_DeathDelayTime_MetaData) };
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatDamageableBox_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatDamageable_NoRegister, (int32)VTABLE_OFFSET(ACombatDamageableBox, ICombatDamageable), false },  // 2813567163
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_scott_Desktop_MythAdventure_MythAdventure_Source_MythAdventure_Variant_Combat_CombatDamageableBox_h__Script_MythAdventure_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatDamageableBox, ACombatDamageableBox::StaticClass, TEXT("ACombatDamageableBox"), &Z_Registration_Info_UClass_ACombatDamageableBox, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatDamageableBox), 3147542994U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_scott_Desktop_MythAdventure_MythAdventure_Source_MythAdventure_Variant_Combat_CombatDamageableBox_h__Script_MythAdventure_1287208671(TEXT("/Script/MythAdventure"),
	Z_CompiledInDeferFile_FID_Users_scott_Desktop_MythAdventure_MythAdventure_Source_MythAdventure_Variant_Combat_CombatDamageableBox_h__Script_MythAdventure_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_scott_Desktop_MythAdventure_MythAdventure_Source_MythAdventure_Variant_Combat_CombatDamageableBox_h__Script_MythAdventure_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
